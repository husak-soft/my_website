			...
			<header className="sticky top-0 z-50 bg-[#0A0A0A] bg-opacity-95 backdrop-blur-sm border-b border-[#1A1A1A]">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center relative">
					...
					<div className="flex items-center space-x-4">
						...
						<a
							href="#contact"
							className="hidden md:inline-flex px-5 py-2 rounded-full border border-accent text-accent text-sm font-semibold glow-hover hover:bg-accent hover:text-black"
						>
							Start Project
						</a>
						<button
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						{filteredProjects.map((project, idx) => (
							<div
								key={project.id}
								className="bg-[#141414] rounded-2xl overflow-hidden border border-gray-800 glow-hover group reveal-on-scroll"
		...
		const faqs = [
			{
				...
				answer:
					"We specialize in custom software development, web and mobile applications, AI/ML integration, e-commerce platforms, and enterprise solutions. Our expertise spans FinTech, HealthTech, E-Commerce, and SaaS products across multiple industries.",
			},
			{
				id: 2,
				category: "Process",
			...
			},
			{
				...
				answer:
					"Our tech stack includes React, Node.js, Python, TypeScript, Next.js, AWS, Google Cloud, TensorFlow, and more. We select technologies based on your specific needs, scalability requirements, and long-term maintenance considerations.",
			},
			{
				id: 6,
				category: "Support",
	...
	const ContactSection: React.FC = () => {
		...
		return (
			<section id="contact" className="py-24 bg-[#1A1A1A]">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="bg-[#141414] p-8 md:p-12 rounded-2xl reveal-on-scroll border border-gray-800">
							...
							<div>
								<form className="space-y-4" onSubmit={handleSubmit}>
									<input
										...
										className="w-full px-4 py-3 rounded-lg bg-[#0A0A0A] border border-gray-700 text-white placeholder-gray-500 focus:border-accent focus:ring-1 focus:ring-accent transition duration-300 outline-none"
									/>
									<input
										type="email"
									...
									<textarea
										...
										rows={4}
										className="w-full px-4 py-3 rounded-lg bg-[#0A0A0A] border border-gray-700 text-white placeholder-gray-500 focus:border-accent focus:ring-1 focus:ring-accent transition duration-300 outline-none resize-none"
									></textarea>
									<button
										type="submit"
										className="w-full px-4 py-3 rounded-xl bg-accent text-black font-bold text-lg glow-hover hover:opacity-90 transition duration-300 shadow-xl"
									>
										Send Inquiry
									</button>
								</form>
